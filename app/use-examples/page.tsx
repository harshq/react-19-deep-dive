        ...
        <ThemeProvider>
            <div className="bg-gradient-to-tr from-teal-100 to-rose-100 w-full min-h-screen overflow-hidden">
                <div className="container mx-auto flex flex-col py-6 px-4 gap-y-6">
                    <h1 className="text-4xl font-bold"><code>use</code> API examples (<a href="https://harshq.medium.com/use-api-react-19-deep-dive-part-1-5e6a8383127e" className="text-blue-700 underline decoration-dashed">blog post</a>)</h1>
